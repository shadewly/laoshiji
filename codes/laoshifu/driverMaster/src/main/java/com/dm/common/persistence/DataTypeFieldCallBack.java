package com.dm.common.persistence;

import com.dm.common.persistence.annotation.DataType;
 ...
 */
public class DataTypeFieldCallBack implements ReflectionUtils.FieldCallback {
    private static Logger logger = LoggerFactory.getLogger(DataTypeFieldCallBack.class);

    private static int AUTOWIRE_MODE = AutowireCapableBeanFactory.AUTOWIRE_BY_NAME;

    private static String ERROR_ENTITY_VALUE_NOT_SAME = "@DataType(entity) "
            + "value should have same type with injected generic type.";
    private static String WARN_NON_GENERIC_VALUE = "@DataType annotation assigned "
    ...
    public DataTypeFieldCallBack(ConfigurableListableBeanFactory bf, Object bean) {
    ...
    public void doWith(Field field)
        ...
        Class<?> classValue = field.getDeclaredAnnotation(DataType.class).entity();
